...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div>
      ...
      <a href="/mantra.php" class="btn-primary">Mantras &amp; Tantra</a>
      <a href="/stories.php" class="btn-secondary">Sacred Stories</a>
    </div>
  </div>
</section>
...
<section class="section" style="background: linear-gradient(to bottom, var(--black), var(--deep));">
  <div class="section-inner">
    <h2 class="section-title">Who is Kaal Bhairav?</h2>
    ...
    <div class="two-col">
      ...
      <div>
        <div class="highlight-box">
          <h3 class="card-title" style="margin-bottom:1rem;">Key Attributes</h3>
          <table>
            <tr><th>Attribute</th><th>Details</th></tr>
            <tr><td>Also Known As</td><td>Kshetrapala, Kotwal, Dandapani</td></tr>
            <tr><td>Form</td><td>Fierce aspect (Ugra) of Shiva</td></tr>
            <tr><td>Vahana</td><td>Black Dog (Shvan)</td></tr>
            <tr><td>Color</td><td>Dark blue / Black</td></tr>
            <tr><td>Day</td><td>Bhairav Ashtami, Sunday, Tuesday</td></tr>
            <tr><td>Primary Dhaam</td><td>Kaal Bhairav Temple, Varanasi</td></tr>
            <tr><td>Sacred River</td><td>Shipra (Ujjain), Ganga (Kashi)</td></tr>
            <tr><td>Forms</td><td>64 Bhairavas (Ashtabhairav × 8)</td></tr>
          </table>
        </div>
      </div>
    </div>
...
<section class="section">
  <div class="section-inner">
    <h2 class="section-title">Explore the Sacred Knowledge</h2>
    <div class="gold-line"></div>
    <div class="card-grid">
      ...
      <a href="/stories.php" style="text-decoration:none;">
        <div class="card">
          ...
          <h3 class="card-title">Sacred Stories</h3>
          <p class="card-text">The beheading of Brahma, origin of Kaal Bhairav, the legend of Kashi Kotwal, and stories from Shiva Purana, Skanda Purana, and Tantric texts.</p>
        </div>
      </a>
      ...
      <a href="/64-bhairav.php" style="text-decoration:none;">
        <div class="card">
          <div class="card-icon">🔱</div>
          <h3 class="card-title">64 Forms of Bhairav</h3>
          <p class="card-text">The 64 Bhairavas — 8 Ashtabhairavas each commanding 8 sub-forms. Each form governs a specific direction, power, and aspect of cosmic energy.</p>
        </div>
      </a>
      ...
      <a href="/pooja-vidhi.php" style="text-decoration:none;">
        <div class="card">
          <div class="card-icon">🪔</div>
          <h3 class="card-title">Pooja Vidhi</h3>
          <p class="card-text">Complete step-by-step Kaal Bhairav pooja procedure — materials required, sankalpa, abhishek, naivedya, aarti, and known spiritual effects.</p>
        </div>
      </a>
      ...
      <a href="/mantra.php" style="text-decoration:none;">
        <div class="card">
          <div class="card-icon">🔔</div>
          <h3 class="card-title">Mantras &amp; Tantra</h3>
          <p class="card-text">Mool mantra, Ashtakam, Bhairav Gayatri, beej mantras, and Tantric practices — with proper guidance, effects, and fair-use principles.</p>
        </div>
      </a>
      ...
      <a href="/seva.php" style="text-decoration:none;">
        <div class="card">
          <div class="card-icon">🐕</div>
          <h3 class="card-title">Dog Seva &amp; Donation</h3>
          <p class="card-text">The dog is Bhairav's sacred vahana. Feeding and caring for dogs — especially strays — is one of the highest forms of Bhairav seva.</p>
        </div>
      </a>
      ...
      <a href="/about.php" style="text-decoration:none;">
        <div class="card">
          ...
          <h3 class="card-title">About Kaal Bhairav</h3>
          <p class="card-text">Iconography, significance, connection to Shaivism and Tantra, Bhairav in different traditions — Shaiva, Shakta, and Nath sampradaya.</p>
        </div>
      </a>
...
<section class="section" style="background: linear-gradient(135deg, rgba(139,0,0,0.08), var(--deep));">
  <div class="section-inner">
    <h2 class="section-title">The Mool Mantra</h2>
    <div class="gold-line"></div>
    <div class="mantra-block">
      ...
      <button onclick="copyMantra('ॐ हृीं बटुकाय आपदुद्धारणाय कुरु कुरु बटुकाय हृीं')"
        class="btn-secondary" style="font-size:0.8rem; padding:0.5rem 1.5rem;">
        Copy Mantra
      </button>
    </div>
    <p class="text-center" style="color:var(--smoke); font-size:0.9rem; font-style:italic;">
      Chant 108 times daily, preferably on Sunday or Tuesday, facing South.<br>
...
<section class="section">
  <div class="section-inner">
    <h2 class="section-title">Kashi — The Eternal City</h2>
    <div class="gold-line"></div>
    <div class="story-block">
      <span class="source-tag">Source: Kashi Khanda, Skanda Purana</span>
      <h3 class="story-title">Why Kaal Bhairav is Kashi's Guardian</h3>
      <p>
    ...
    <div class="text-center mt-2">
      <a href="/stories.php" class="btn-secondary">Read All Sacred Stories →</a>
    </div>
  </div>
</section>
...
<section class="section" style="background: linear-gradient(to bottom, var(--deep), var(--black));">
  <div class="section-inner">
    <div class="donation-section">
      ...
      <h2 class="section-title" style="margin-bottom:0.5rem;">Feed a Dog, Please Bhairav</h2>
      <div class="gold-line"></div>
      <p style="color:var(--smoke); max-width:600px; margin:0 auto 1.5rem;">
      ...
      <a href="/seva.php" class="btn-primary">Contribute to Dog Seva</a>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="section-inner">
    <div class="disclaimer-box">
      <h3>⚠ Important Notice — Please Read</h3>
      <p>
        ...
        <a href="/disclaimer.php" style="color:var(--gold);">Read full disclaimer →</a>
      </p>
    </div>
  </div>
</section>
