<?php global $base_href; ?>
<!-- WhatsApp Share Bar (mobile only) -->
<div id="wa-share-bar">
  <span class="wa-text" data-key="wa_share_label">Share this page</span>
  <a id="wa-share-btn" href="#" target="_blank" rel="noopener">
    ...
    <span data-key="wa_share_btn">Share on WhatsApp</span>
  </a>
  <button id="wa-close-btn" aria-label="Close">✕</button>
</div>
<footer>
    <div class="footer-inner">
        ...
        <ul class="footer-links">
            ...
            <li><a href="<?php echo $base_href; ?>bhairav-ashtami-2026.php" data-key="nav_ashtami">Ashtami 2026</a></li>
            <li><a href="<?php echo $base_href; ?>kaal-bhairav-jayanti-2026.php" data-key="nav_jayanti">Jayanti 2026</a></li>
            <li><a href="<?php echo $base_href; ?>disclaimer.php" data-key="nav_disclaimer">Disclaimer</a></li>
        </ul>
        <p class="footer-text" data-key="footer_tagline">Jay Kaal Bhairav · जय काल भैरव · <span class="footer-note">Dogs are sacred to Kaal Bhairav. Be kind to animals.</span></p>
