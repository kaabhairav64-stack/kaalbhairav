...
<section class="section">
  <div class="section-inner">
    ...
    <div class="disclaimer-box">
      <h3>⚠ Guidance on Mantra Practice</h3>
      <p>Mantras are sacred sound formulas with deep vibrational energy. They should be practiced with sincerity, regularity, and righteous intent. <strong>Never use any mantra or Tantric practice to harm another person</strong> — this is explicitly forbidden in all authentic Shaiva and Tantric traditions and will create severe negative karma for the practitioner. For Tantric practices beyond basic mantra japa, guidance from a qualified guru is strongly recommended.</p>
    </div>
    ...
    <div class="highlight-box">
      <h4 class="card-title">How to Practice</h4>
      <p style="color:var(--ash);">Chant 108 times daily using a Rudraksha mala. Best time: Sunday mornings, Tuesday evenings, or midnight. Face South (Bhairav's direction). Sit in a clean place with a lamp lit. Results: protection, fear removal, obstacle clearing. Regular practice over 40 days (a <em>mandala</em>) creates noticeable effects.</p>
    </div>
    ...
    <div class="highlight-box">
      <p style="color:var(--ash);">This is one of the most popular and accessible Bhairav mantras. Chant 108 times minimum. Very effective for removing sudden dangers, health crises, travel safety, and sudden reversals of fortune. Source: <em>Batuk Bhairav Tantram</em>.</p>
    </div>
    ...
    <div class="card-grid">
      <div class="card">
        <h3 class="card-title">Bhairav Beej</h3>
        <p class="mantra-text" style="font-size:2rem; text-align:center; margin:1rem 0;">हृीं</p>
        <p class="card-text"><em>Hreem</em> — the primary beej of Bhairav. Represents his shakti, maya-piercing energy, and direct connection to cosmic consciousness. Used in Tantra as the core seed syllable.</p>
      </div>
      <div class="card">
        <h3 class="card-title">Kaal Beej</h3>
        <p class="mantra-text" style="font-size:2rem; text-align:center; margin:1rem 0;">क्रीं</p>
        <p class="card-text"><em>Kreem</em> — the beej of Kali, the time-force. Used in Kaal Bhairav practice to invoke the aspect of time-transcendence and dissolution of karma.</p>
      </div>
      <div class="card">
        <h3 class="card-title">Mrityu Beej</h3>
        <p class="mantra-text" style="font-size:2rem; text-align:center; margin:1rem 0;">ॐ</p>
        <p class="card-text"><em>Om</em> — the universal sound, the beej of all mantras. Always precedes Bhairav mantras to establish cosmic resonance.</p>
      </div>
    </div>
    ...
    <div class="disclaimer-box" style="margin-bottom:1.5rem;">
      <p>The complete Ashtakam is an ancient Sanskrit text of 8 stanzas describing the glory, attributes, and grace of Kaal Bhairav. Below is a description of each verse with its meaning and significance. The full Sanskrit text is found in <em>Shankaracharya's Stotra Sangraha</em>.</p>
    </div>
    ...
    <div class="disclaimer-box">
      <h3>⚠ Critical Warning on Tantric Practices</h3>
    ...
    <div class="card-grid" style="margin-top:2rem;">
      <div class="card">
        ...
        <h3 class="card-title">Shmashana Sadhana</h3>
        <p class="card-text">Advanced practice performed in cremation grounds at midnight. Requires proper initiation, fearlessness, and guidance. Considered the most direct way to experience Bhairav's presence. Only for initiated Tantrics.</p>
      </div>
      <div class="card">
        <div class="card-icon">🔱</div>
        <h3 class="card-title">Bhairav Yantra</h3>
        <p class="card-text">A geometric diagram (yantra) representing Bhairav's cosmic form. It is energized through mantra and ritual and kept in the worship space. Acts as a permanent focal point of Bhairav's energy for protection and blessings.</p>
      </div>
      <div class="card">
        <div class="card-icon">📿</div>
        <h3 class="card-title">Purashcharana</h3>
        <p class="card-text">A dedicated repetition of Bhairav's mantra — 100,000 times (1 lakh) minimum for basic activation, typically done over 40 days. Requires specific dietary, behavioral, and ritual restrictions throughout the period.</p>
      </div>
      <div class="card">
        <div class="card-icon">🌑</div>
        <h3 class="card-title">Amavasya Sadhana</h3>
        <p class="card-text">Special practice performed on the new moon night. Begins at midnight. Includes mantra japa, lamp offering, and offerings of sesame and iron. Considered highly potent for removing stubborn obstacles.</p>
      </div>
    </div>

    <div class="disclaimer-box" style="margin-top:3rem;">
      <h3>The Core Principle of Righteous Practice</h3>
      <p>All authentic Shaiva Tantric traditions agree: <strong>Bhairav himself punishes those who misuse his energy.</strong> He is the Kotwal of cosmic justice. Using any practice for manipulation, control, or harm of others will invoke Bhairav's wrath — not his grace. The practitioner who approaches Bhairav with ego, greed, or malice will find their own karma accelerated and amplified. <em>True Bhairav sadhana dissolves the ego — it does not inflate it.</em></p>
    </div>
