<?php
$page_title    = "Dog Seva &amp; Donation — Feed Bhairav's Vahana | kaalbhairav.org";
  ...
  <div class="section-inner">
    ...
    <div class="donation-section">
      ...
      <div class="donation-amount-grid">
        ...
        <button class="amount-btn" data-amount="1008">₹ 1008</button>
        <button class="amount-btn" data-amount="2100">₹ 2100</button>
      </div>

      <div style="margin: 1rem 0;">
        <input type="number" id="custom-amount" placeholder="Or enter custom amount (₹)"
          style="background:rgba(0,0,0,0.4); border:1px solid var(--border); color:var(--ash);
            font-family:'EB Garamond',serif; font-size:1rem; padding:0.7rem 1.2rem;
            border-radius:3px; width:260px; text-align:center; outline:none;">
      </div>
...
<div style="display:none;" aria-hidden="true">
  <h2>कुत्ता सेवा — काल भैरव की सबसे बड़ी भक्ति</h2>
  <h3>कुत्ता सेवा क्यों करें?</h3>
  <p>कुत्ता काल भैरव का वाहन (सवारी) है। भैरव अगम और शिव पुराण के अनुसार, कुत्ते को खाना खिलाना साक्षात काल भैरव की सेवा है। हर पूजा से पहले कुत्ते को खिलाना अनिवार्य माना गया है — यह पहली और सबसे महत्वपूर्ण भेंट है।</p>
  <h3>कैसे करें कुत्ता सेवा?</h3>
  <p>किसी भी कुत्ते को — चाहे वह आवारा हो या पालतू — रोटी, चावल, दूध या कुत्ते का खाना खिलाएं। काले कुत्ते को खिलाना सबसे शुभ है। रविवार, मंगलवार और हर अष्टमी पर विशेष रूप से करें। पूजा से पहले और शाम को दोनों समय करने से दोहरा फल मिलता है।</p>
  <h3>कुत्ता सेवा के फल</h3>
  <p>नकारात्मक कर्म का नाश, भैरव की प्रत्यक्ष कृपा, परिवार की सुरक्षा, मानसिक शांति और आध्यात्मिक उन्नति। एक कुत्ते को एक रोटी — और काल भैरव प्रसन्न। यह सबसे सरल और सबसे शक्तिशाली भक्ति मार्ग है।</p>
  <h3>आज ही शुरू करें</h3>
  <p>आज किसी भी कुत्ते को खाना खिलाएं। यही भैरव पूजा है। यही कुत्ता सेवा है। KaalBhairav.org — काल भैरव की जानकारी, मंत्र, पूजा विधि और कुत्ता सेवा का संपूर्ण मार्गदर्शन।</p>
</div>
</noscript>
